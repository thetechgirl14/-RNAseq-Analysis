...
dds <- DESeqDataSetFromMatrix(countData = round(counts_filt), colData = coldata, design =~ age)
...
write.csv(sig_genes_with_id, paste0(path,"differential_expression_aging.csv"))